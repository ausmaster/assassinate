...
class Module:
    ...
    async def fullname(self) -> str:
        ...
        Example:
            ...
            exploit/unix/ftp/vsftpd_234_backdoor
        """
        info = await call_client_method(self._client, "module_info", self._module_id)
    ...
    async def set_option(self, key: str, value: str) -> None:
        ...
        """
        await call_client_method(self._client, "module_set_option", self._module_id, key, value)
    ...
    async def get_option(self, key: str) -> str | None:
        ...
        Example:
            ...
            192.168.1.100
        """
        return await call_client_method(self._client, "module_get_option", self._module_id, key)
    ...
    async def validate(self) -> bool:
        ...
        Example:
            ...
            ...     print("Ready to run!")
        """
        return await call_client_method(self._client, "module_validate", self._module_id)
    ...
    async def exploit(
        ...
        """
        return await call_client_method(self._client, "module_exploit", 
    ...
    async def run(self, options: dict[str, str] | None = None) -> bool:
        ...
        """
        return await call_client_method(self._client, "module_run", self._module_id, options)
    ...
    async def check(self) -> str:
        ...
        Example:
            ...
            Appears vulnerable
        """
        return await call_client_method(self._client, "module_check", self._module_id)
    ...
    async def has_check(self) -> bool:
        ...
        Example:
            ...
            ...     result = await mod.check()
        """
        return await call_client_method(self._client, "module_has_check", self._module_id)
    ...
    async def compatible_payloads(self) -> list[str]:
        ...
        Example:
            ...
            cmd/unix/reverse
        """
        return await call_client_method(self._client, "module_compatible_payloads", self._module_id)
    ...
    async def options(self) -> str:
        ...
        Example:
            ...
            >>> print(opts)
        """
        return await call_client_method(self._client, "module_options", self._module_id)
    ...
    async def targets(self) -> list[str]:
        ...
        Example:
            ...
            ...     print(target)
        """
        return await call_client_method(self._client, "module_targets", self._module_id)
    ...
    async def aliases(self) -> list[str]:
        ...
        """
        return await call_client_method(self._client, "module_aliases", self._module_id)
    ...
    async def notes(self) -> dict[str, str]:
        ...
        Example:
            ...
            ...     print(f"{key}: {value}")
        """
        return await call_client_method(self._client, "module_notes", self._module_id)
