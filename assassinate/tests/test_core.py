"""Unit tests for synchronous Metasploit Core Python bindings.

This module contains unit tests for the synchronous Python bindings,
...
class TestMetasploitCore(TestCase):
