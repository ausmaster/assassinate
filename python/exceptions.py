...
class MetasploitError(Exception):
    ...
    .. note::
        This exception is not meant to be raised directly. Use specific subclasses instead.

    .. seealso:: :class:`InitializationError`, :class:`ValidationError`, :class:`ExecutionError`
    """
...
class InitializationError(MetasploitError):
    ...
    This can occur if the shared library cannot be loaded, or initialization steps fail.
...
class ValidationError(MetasploitError):
    ...
    This occurs when an API call receives invalid arguments or malformed options.
...
class ExecutionError(MetasploitError):
    ...
    This happens if a module cannot run due to internal errors or missing dependencies.
...
class SessionError(MetasploitError):
    ...
    .. seealso:: :func:`core.msf_interact_session`, :func:`core.msf_close_session`
    """
